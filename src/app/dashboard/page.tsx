      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            {/* Main Action Card: Gym Attendance */}
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="absolute inset-0 w-full h-full group-hover:scale-105 transition-transform duration-700 opacity-30 pointer-events-none">
                <Image 
                   src="https://images.unsplash.com/photo-1517838277536-f5f99be501cd?q=70&w=800" 
                   alt="" 
                   fill
                   sizes="(max-width: 768px) 100vw, 600px"
                   className="object-cover"
              ...
              <div className="relative z-20 p-12 h-full flex flex-col justify-end min-h-[360px]">
                 ...
                 <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4 uppercase">Attendance &amp; Streaks</h2>
                 <p className="text-gray-300 max-w-md mb-8 text-sm">
                   Mark today&apos;s check-in, track your current consistency streak, view your monthly reports, and manage your attendance logs.
                 </p>
                 <button className="self-start px-8 py-3.5 bg-white text-black font-bold uppercase tracking-widest rounded-full hover:bg-gray-200 transition-colors flex items-center gap-2 text-xs">
